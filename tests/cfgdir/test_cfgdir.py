...
def test_json_switch():
    _cli(['tests/data/cfg', '-j'],
         {'KEY_1': '1', 'KEY_2': '2', 'KEY_3': 'foo'})


def test_overwrite():
    _cli(['tests/data/cfg5', 'tests/data/default.json'],
